...
void mandar_SMS0(String menssage, String destiny){
  Serial.println("Enviando SMS...");
  GSMSerial.print("AT+CMGF=1\r"); 
  delay(1000);
  
  GSMSerial.println(destiny);
  delay(1000);
  GSMSerial.println(menssage);
  delay(100);
...
void loop(){  
    ...
    if (buttonStartState == LOW )
    {
       ...
       Serial.println("FisrtMedicion: ");
        mandar_SMS0(firstMedicion, "AT+CMGS=\"+51944242562\"\r"); // a Jeffrey
        mandar_SMS0(firstMedicion, "AT+CMGS=\"+51940433430\"\r"); // a Cesar
        mandar_SMS0(firstMedicion, "AT+CMGS=\"+51999729166\"\r"); // a Stoyan
        blinkLedPin(4, 200);
        cont1 = 0;
        }
    }
